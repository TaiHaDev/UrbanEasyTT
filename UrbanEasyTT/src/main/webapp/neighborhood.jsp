...
<body>
    ...
    <div class="structure-content">
        ...
        <form action="neighborhood" method="get" class="name-title">
            <input type="text" name="neighborhood" class="input-map-search" value="neighborhoodSaved" placeholder="Write some description"/>
